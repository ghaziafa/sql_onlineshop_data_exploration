...
INSERT INTO store VALUES(11,'Choby Collection','Quebec','Montreal','No.2012 Sanguinet',4,DEFAULT);
...
Update store set[startTime] = GETDATE() where sid = 11;
/*INSERT INTO store('11','startTime') values(GETDATE()) ON duplicate ;*/

/*INSERT INTO store VALUES(11,'Choby Collection','Quebec','Montreal','No.2012 Sanguinet',4,DEFAULT) on  DUPLICATE KEY UPDATE store set[startTime] = GETDATE();*/
select * from Store
...
/*find the service pint with 'address', 'opening timings' in user city*/
...
/*retrieve quantity of produkt from ftore with id = 8 from shopping cart*/
 
select sum(quantity) as totalqantity
from Save_to_Shopping_Cart
where Save_to_Shopping_Cart.pid in(select product.pid from product where sid=8);

/*:::::::::::::::::::::::::::::::::::::::::*/

/*NAME & ADDRESSS OF ORDER DELIVERED ON 2017-02-17*/
...
/*retrieve comment for product with id 12345678*/
select * from comments where pid = '12345678';

/*:::::::::::::::::::::::::::*/

/*DATA MODIFICATION*/

/*insert userid of sellers whose name start with A into buyers*/
...
/*updating payment state of orders to unpaid where creation time is 2018 and quantity is > 50*/

update orders
set paymentstate = 'Unpaid'
where creationtime > '2017' and totalamount > '50';

/*::::::::::::::::::::::::::::::::::::::::::::*/

/*update contact and name of address where city is mostreal*/

update address 
set name = 'fozia', contactphonenumber = '789'
...
/*CREATE View of all products with price above average*/

create view products_above_ave_price as
select pid, name, price
from product
where price > (select avg(price) from product)
select * from products_above_ave_price;

/*:::::::::::::::::::::::::::::::::::::::::::::::::::*/

/*create view  of all sales in 2016*/

create view all_sales_in_2016 as /* tis will retrieve orders with product detail*/
select pid, name, price
from product
where pid in (select pid from orderitem where itemid in (select itemid from contain where ordernumber in 
(select ordernumber from payment where paytime > '2016-01-01' and paytime < '2016-12-31')));
select * from all_sales_in_2016;


create view sales_in_2016 as /*this will retrieve only ordernumbers*/
select ordernumber from payment where paytime > '2016-01-01' and paytime < '2016-12-31'
select * from sales_in_2016;
